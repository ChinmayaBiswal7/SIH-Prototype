...
def init_db():
    ...
    cabin_updates = [
        ("GHOST_01", 1, "Navy Blue Polo Shirt (Eyeglasses)", "Lord Ganesha Figurine (Gold) + Centered FASTag", "Steady Arterial Cruise (45 km/h)", "Distinguished from newly-bought showroom Vernas by gold dashboard idol, centered RFID tag, and solo driver in navy polo.",
         '{"total_people_count": 1, "occupants_summary": "1 Person (Solo Driver)", "driver_attire": "Navy Blue Polo", "driver_hex": "#1E3A8A", "passenger_attire": "None", "dashboard_items": ["Gold Ganesha Figurine", "Centered FASTag RFID Barcode"], "kinematics": {"speed": "45 km/h", "lane": "Center Lane", "accel": "Gentle Linear"}, "twin_anti_clone": "Differentiated from factory-fresh Verna via gold dashboard deity, RFID placement & navy blue driver attire.", "seat_map": [{"seat": "Front-R (Driver)", "role": "Driver", "occupied": true, "attire": "Navy Blue Polo", "hex": "#1E3A8A"}, {"seat": "Front-L (Co-Driver)", "role": "Passenger", "occupied": false, "attire": "Empty", "hex": "#334155"}, {"seat": "Rear-L", "role": "Rear Passenger", "occupied": false, "attire": "Empty", "hex": "#334155"}, {"seat": "Rear-R", "role": "Rear Passenger", "occupied": false, "attire": "Empty", "hex": "#334155"}]}'),

        ("GHOST_02", 2, "White Kurta (Driver) + Red T-Shirt (Passenger)", "Hanging Wooden Beads on Mirror + Left Transit Slip", "Aggressive Highway Pace (62 km/h Fast Lane)", "Differentiated from identical showroom Scorpios by dual occupancy (driver in white, passenger in red) & rearview mirror hanging beads.",
         '{"total_people_count": 2, "occupants_summary": "2 People (Driver + Front Co-Passenger)", "driver_attire": "White Kurta", "driver_hex": "#F8FAFC", "passenger_attire": "Red T-Shirt", "dashboard_items": ["Rearview Wooden Mala Beads", "Left Showroom Delivery Permit"], "kinematics": {"speed": "62 km/h", "lane": "Right / Overtaking Lane", "accel": "Rapid Throttle Bursts"}, "twin_anti_clone": "Distinguished from brand new showroom Scorpio-N by dual occupants in contrasting attire and hanging mirror mala.", "seat_map": [{"seat": "Front-R (Driver)", "role": "Driver", "occupied": true, "attire": "Crisp White Kurta", "hex": "#F8FAFC"}, {"seat": "Front-L (Co-Driver)", "role": "Front Passenger", "occupied": true, "attire": "Crimson T-Shirt", "hex": "#DC2626"}, {"seat": "Rear-L", "role": "Rear Passenger", "occupied": false, "attire": "Empty", "hex": "#334155"}, {"seat": "Rear-R", "role": "Rear Passenger", "occupied": false, "attire": "Empty", "hex": "#334155"}]}'),

        ("GHOST_03", 4, "Denim Blue Shirt + Black Baseball Cap", "Spring Bobblehead Toy on Left Dash + Air Freshener", "Cautious City Commute (36 km/h Stop-and-Go)", "Differentiated from identical unplated showroom Swifts by 4-person cabin occupancy (driver in blue, passenger in yellow, 2 rear occupants) and bobblehead toy on dash.",
         '{"total_people_count": 4, "occupants_summary": "4 People (Driver + Co-Driver + 2 Rear Passengers)", "driver_attire": "Denim Blue Shirt", "driver_hex": "#2563EB", "passenger_attire": "Yellow Kurti (Co-Passenger)", "dashboard_items": ["Spring Bobblehead Toy", "Air Freshener Vent Clip"], "kinematics": {"speed": "36 km/h", "lane": "Left Lane", "accel": "Stop-and-Go Commute"}, "twin_anti_clone": "Distinguished from unplated showroom Swift by 4-person cabin occupancy (driver in blue, passenger in yellow, 2 rear occupants) and bobblehead toy on dash.", "seat_map": [{"seat": "Front-R (Driver)", "role": "Driver", "occupied": true, "attire": "Denim Blue Shirt", "hex": "#2563EB"}, {"seat": "Front-L (Co-Driver)", "role": "Front Passenger", "occupied": true, "attire": "Yellow Kurti", "hex": "#EAB308"}, {"seat": "Rear-L", "role": "Rear Left", "occupied": true, "attire": "Light Grey Hoodie", "hex": "#94A3B8"}, {"seat": "Rear-R", "role": "Rear Right", "occupied": true, "attire": "Olive Green Top", "hex": "#16A34A"}]}'),

        ("GHOST_04", 1, "Black Riding Jacket + Red Full-Face Helmet", "Handlebar Aluminum Phone Mount & Tank Grips", "High-Speed Dynamic Weaving (58 km/h)", "Differentiated by rider red helmet, phone mount, and rapid throttle dynamics.",
         '{"total_people_count": 1, "occupants_summary": "1 Person (Solo Motorcycle Rider)", "driver_attire": "Black Armored Jacket", "driver_hex": "#0F172A", "passenger_attire": "Solo Rider", "dashboard_items": ["Handlebar Aluminum Phone Clamp", "Tank Grip Decals"], "kinematics": {"speed": "58 km/h", "lane": "Lane Splitting", "accel": "High RPM Bursts"}, "twin_anti_clone": "Distinguished by rider red helmet, phone mount, and rapid throttle dynamics.", "seat_map": [{"seat": "Rider Saddle", "role": "Primary Rider", "occupied": true, "attire": "Black Armored Jacket & Red Helmet", "hex": "#0F172A"}, {"seat": "Pillion Seat", "role": "Pillion", "occupied": false, "attire": "Empty", "hex": "#334155"}]}')
    ]
